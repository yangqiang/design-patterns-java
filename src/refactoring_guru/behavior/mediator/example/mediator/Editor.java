package refactoring_guru.behavior.mediator.example.mediator;

import refactoring_guru.behavior.mediator.example.components.*;
import refactoring_guru.behavior.mediator.example.components.Component;
import refactoring_guru.behavior.mediator.example.components.List;
...
public class Editor implements Mediator {
    ...
    private refactoring_guru.behavior.mediator.example.components.List list;
