...
import refactoring_guru.behavior.memento.example.commands.ColorCommand;
import refactoring_guru.behavior.memento.example.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                refactoring_guru.behavior.memento.example.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
